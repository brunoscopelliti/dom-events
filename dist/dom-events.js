...
var Store = (function () {
     ...
     * @return {String}
     */
    function getFixedEventName_(type) {
    ...
    function exclude_(list, predicate) {
        ...
        return list.filter(function (val, k, orig) {
            return !predicate.call(_this, val, k, orig);
        });
    }
    ...
    function compare_(comparator, subjectObj) {
        ...
        return loopProps_(comparator, function (prop, k) {
            return typeof prop == "function" ? subjectObj[k][guid] === prop[guid] : subjectObj[k] === prop;
        });
    }
    ...
    function domUp_(startEl, stopEl, func) {
        ...
        if (typeof stopEl == "function") {
            var _ref = [stopEl, window];
            func = _ref[0];
            stopEl = _ref[1];
        }

        var visitorEl = startEl;
        var repeat = true;
...
function contains_(container, contained, strictly) {
    if (typeof contained == "string") {
        var box = strictly ? container : container.parentNode || document;
 ...
 */
function loopProps_(obj, iterator) {
